...
from src.myModel.cir_nas_mbv2_cifar import cir_nas_mobilenet_cifar,pretrain_cir_nas_mobilenet_cifar
...
def cifar_cir_nas_mobilenetv2(pretrained=False, **kwargs):
    model=cir_nas_mobilenet_cifar(10,32,1)
    return model

@register_model
def pretrain_cifar_cir_nas_mobilenetv2(pretrained=False, **kwargs):
    model=pretrain_cir_nas_mobilenet_cifar(10,32,1)
    return model