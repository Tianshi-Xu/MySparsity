...
class QConv2d(torch.nn.Conv2d):
    def __init__(self, m: torch.nn.Conv2d, quan_w_fn=None, quan_a_fn=None,
            sparse_w_fn=None, sparse_a_fn=None, **kwargs):
        ...
        self.sparse_w_fn = sparse_w_fn
        self.sparse_a_fn = sparse_a_fn
    ...
    def forward(self, x):
        ...
        quantized_weight = self.sparse_w_fn(quantized_weight)
        quantized_act = self.quan_a_fn(x)
        quantized_act = self.sparse_a_fn(quantized_act)
