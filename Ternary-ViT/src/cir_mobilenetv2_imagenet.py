...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.):
        ...
        for t, c, n, s in self.cfgs:
            ...
            for i in range(n):
                layers.append(block(input_channel, output_channel, s if i == 0 else 1, t,block_size=self.block_size[idx]))
...
def get_cir_mbv2_imagenet(num_classes=1000, width_mult=1.0) -> MobileNetV2:
