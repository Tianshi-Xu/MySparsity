...
# normal
# CUDA_VISIBLE_DEVICES=4 python train_cirnas.py -c ./configs/datasets/cifar10_kd_nas_mbv2_normal.yml /home/xts/code/dataset/cifar10 --model cifar_cir_nas_mobilenetv2

# finetune
# CUDA_VISIBLE_DEVICES=4 python finetune_cirnas.py -c ./configs/datasets/cifar10_kd_nas_mbv2_finetune.yml /home/xts/code/dataset/cifar10 --model finetune_cifar_cir_nas_mobilenetv2
...
# finetune_fix
CUDA_VISIBLE_DEVICES=7 python finetune_imagenet.py -c ./configs/datasets/cifar_fix_finetune.yml /home/xts/code/dataset/cifar10 --model finetune_cifar_cir_nas_mobilenetv2_fix
