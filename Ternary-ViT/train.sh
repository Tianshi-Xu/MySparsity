...
CUDA_VISIBLE_DEVICES=6 python train_cirnas.py -c ./configs/datasets/imagenet_pretrain.yml /opt/dataset/imagenet --model pretrain_imagenet_cir_nas_mobilenetv2
